...
public class Winner extends JPanel// implements ActionListener
{
    ...
    public Winner (Color[] c, int[] ss, String p, JPanel pA, JPanel pB)
    {
		...
		lPanel.setPreferredSize(new Dimension(ss[9], 0));
		lPanel.setBorder(new EmptyBorder(ss[10], 20, ss[10], 20));
		...
		rPanel.setPreferredSize(new Dimension(ss[9], 0));
		rPanel.setBorder(new EmptyBorder(ss[10], 20, ss[10], 20));

...
public class Winner extends JPanel// implements ActionListener
{
    ...
    public Winner (Color[] c, int[] ss, String p, JPanel pA, JPanel pB)
    {
		...
		lPanel.setPreferredSize(new Dimension(ss[8], 0));
		lPanel.setBorder(new EmptyBorder(ss[9], 20, ss[9], 20));
		...
		cPanel = new JPanel();
		Border b = BorderFactory.createMatteBorder(ss[10], 20, ss[10], 20, colors[0]);
		...
		rPanel.setPreferredSize(new Dimension(ss[8], 0));
		rPanel.setBorder(new EmptyBorder(ss[9], 20, ss[9], 20));
